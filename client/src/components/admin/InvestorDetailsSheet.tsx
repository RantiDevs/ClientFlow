...
export function InvestorDetailsSheet({ investor, open, onOpenChange }: InvestorDetailsSheetProps) {
  ...
  const transactions = [
    { id: "TRX-9821", date: "2024-04-15", type: "Distribution", amount: "$12,500.00", status: "Completed" },
    { id: "TRX-9803", date: "2024-03-15", type: "Distribution", amount: "$12,500.00", status: "Completed" },
    { id: "TRX-9755", date: "2024-02-01", type: "Contribution", amount: "$150,000.00", status: "Completed" },
    { id: "TRX-9122", date: "2024-01-15", type: "Distribution", amount: "$8,250.00", status: "Completed" },
  ];
