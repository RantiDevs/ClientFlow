...
export function InvestorDetailsDialog({ open, onOpenChange, investor }: InvestorDetailsDialogProps) {
  ...
  const transactions = [
    { id: "TRX-9821", date: "2024-04-15", type: "Distribution", amount: "$12,500.00", status: "Completed", property: "The Pavilion Hostel" },
    { id: "TRX-9820", date: "2024-03-15", type: "Distribution", amount: "$12,500.00", status: "Completed", property: "The Pavilion Hostel" },
    { id: "TRX-9755", date: "2024-02-28", type: "Contribution", amount: "$50,000.00", status: "Completed", property: "Skyline Apartments" },
    { id: "TRX-9610", date: "2024-02-15", type: "Distribution", amount: "$11,200.00", status: "Completed", property: "The Pavilion Hostel" },
  ];
                        ...
                        <TabsContent value="overview" className="mt-0 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
                                    ...
                                    <h3 className="text-2xl font-bold text-green-600">+$145,250</h3>
                                </div>
                            </div>
