                    ...
                    {[...Array(5)].map((_, c) => (
                      <td key={c} className="border border-slate-200 px-4 py-1 text-slate-700">
                        {r === 0 ? ["Property", "Unit", "Tenant", "Rent", "Status"][c] : 
                         r === 1 ? ["The Pavilion", "101", "John Doe", "$1,200", "Paid"][c] :
                         r === 2 ? ["The Pavilion", "102", "Jane Smith", "$1,450", "Paid"][c] :
                         ""}
                      </td>
                    ))}
                  </tr>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 my-6">
              <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
                ...
                <p className="text-2xl font-bold text-slate-900 mt-1">$142,500</p>
              ...
              <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
                ...
                <p className="text-2xl font-bold text-slate-900 mt-1">$89,200</p>
